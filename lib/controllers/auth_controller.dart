...
class AuthController extends GetxController {
  ...
  Future<void> storeUserDataToFirestore(UserCredential userCredential, File image) async {
  ...
  Future<String> uploadImageToStorage(File imageFile, String userID) async {
    ...
    final Reference storageReference = FirebaseStorage.instance.ref().child('user_images').child('$userID.jpg');
